...
public class TourismScheduleActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        EdgeToEdge.enable(this);
        setContentView(R.layout.tools_activity_tourism_schedule);
...
//            installedPackageDialogue.show(fm, "fragment_alert");
            getSupportFragmentManager()
                    .beginTransaction()
                    .replace(R.id.content, TourismScheduleResultFragment.newInstance(), null)
